...
#     config = get_extension_config()
#     name = config["name"]
#     dir = get_comfy_dir("web/extensions/booru_tagger")
...
#     PromptServer.instance.send_sync("booru_tagger_download/update_status", {
#         "node": node,
#         "progress": progress,
#         "text": text
#     }, client_id)
...
#     await PromptServer.instance.send("booru_tagger_download/update_status", {
#         "node": node,
#         "progress": progress,
#         "text": text
#     }, client_id)
